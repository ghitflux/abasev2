...
class DashboardDetailRowSerializer(serializers.Serializer):
    ...
    data_entrada_associacao = serializers.CharField(required=False, allow_blank=True)
    parcelas_descontadas = serializers.IntegerField(required=False, allow_null=True)
    status_resumo_mensal = serializers.CharField(required=False, allow_blank=True)
