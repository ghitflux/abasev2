...
export const V1TesourariaLiquidacoesExcluirCreatePathParamsSchema = z.object({
  id: z.coerce
    .number()
    .int()
...
export const V1TesourariaLiquidacoesExcluirCreate200Schema = z.lazy(
  () => liquidacaoContratoListSchema,
);

export const V1TesourariaLiquidacoesExcluirCreateMutationRequestSchema = z
...
export const V1TesourariaLiquidacoesExcluirCreateMutationResponseSchema =
  z.lazy(() => V1TesourariaLiquidacoesExcluirCreate200Schema);
