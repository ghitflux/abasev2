...
export const V1EsteiraAprovarCreatePathParamsSchema = z.object({
  id: z.coerce
    .number()
    .int()
...
export const V1EsteiraAprovarCreate200Schema = z.lazy(() => esteiraListSchema);

export const V1EsteiraAprovarCreateMutationRequestSchema = z
